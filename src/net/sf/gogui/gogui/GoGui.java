            ...
            ContextMenu.Listener, LiveGfx.Listener
{
    ...
    public void actionTruncate(boolean showMessage)
    {
        if (! checkStateChangePossible())
            return;
    ...
    /**
     * Show a message error in a JPanel if the computer is thinking since more than 500ms
     * and the user is trying to do something with the board.
     * @return true if the program is thinking and the user is trying to do something
     */
